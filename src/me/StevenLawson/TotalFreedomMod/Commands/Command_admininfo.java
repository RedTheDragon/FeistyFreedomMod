...
public class Command_admininfo extends TFM_Command
{
    ...
    public boolean run(CommandSender sender, Player sender_p, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        TFM_Util.playerMsg(sender_p, "Go to our forums at http://feistyfreedom.boards.net/", ChatColor.GREEN);
        TFM_Util.playerMsg(sender_p, "Create a thread in the Super Admin applications forum following the template:", ChatColor.GREEN);
        TFM_Util.playerMsg(sender_p, "http://feistyfreedom.boards.net/thread/4/new-super-admin-template", ChatColor.GREEN);
