...
public enum TFM_PlayerRank
{
    ...
    CO("one of the " + ChatColor.BLUE + "Co Owners", ChatColor.BLUE + "(Co Owner)"),
    RED("one of the " + ChatColor.BLUE + "Co Owners and the FiestyFreedomMod Creator", ChatColor.BLUE + "(Co Owner + Dev)"),
    ...
    public static TFM_PlayerRank fromSender(CommandSender sender)
    {
        ...
        else if (sender.getName().equals("MatthewGFX"))
        {
            return OWNER;
        }

        else if (sender.getName().equals("XMentelCatPvpzX"))
        {
            return CO;
        }
